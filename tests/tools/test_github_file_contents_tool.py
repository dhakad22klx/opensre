...
from tools.github_file_contents_tool import get_github_file_contents
...
def test_run_happy_path() -> None:
    ...
    with (
        ...
        patch("tools.github_file_contents_tool.call_github_mcp_tool", return_value=fake_result),
    ):
